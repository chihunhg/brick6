                ...
                <div class="container">
                    ...
                    <article class="card">
                        <p>
                            ...
                            請別忘了，先到工具欄的<b>「SEO/GEO基本設定」</b>介紹你的網站並埋設追蹤碼！
                        </p>
                        <hr>
                        <p><b>【<u>SEO/GEO基本設定</u> 是什麼？】</b>是跟「搜索引擎」介紹網站在做什麼。</p>
                        <ul>
                            <li>管理者可至「SEO/GEO基本設定」填寫「Meta、結構化資料」及「埋設追蹤碼」，讓「搜索引擎」更認識你的網站。</li>
