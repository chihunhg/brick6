...
function fieldCheck0(theForm) {
	...
	if ($('#Class1').length > 0 && $('#Class1').val() === '') {
		errors.push('<?php echo e((string)($Class_Name[1] ?? '大類')); ?>請選擇');
		array.push('Class1');
	}

	if ($('#Class2').length > 0 && $('#Class2').val() === '') {
		errors.push('<?php echo e((string)($Class_Name[2] ?? '中類')); ?>請選擇');
		array.push('Class2');
	}
                    ...
                    <section class="editView">
                        ...
                        <article class="editView__body">
                            <div class="editView__section">
                                ...
                                <div class="formGrid">
                                    <label class="col--2 inputLabel editView__formLabel" for="Upload"><?php echo $Class_Name[2]?>名稱 <span class="inputLabel__required">*</span></label>
                                    <div class="col--10">
