...
$listCsrfKey = (string)($detailConfig['list_csrf'] ?? 'couponreg_list');
...
$sortCol = preg_replace('/[^a-zA-Z0-9_]/', '', (string)($detailConfig['sort_column'] ?? 'PKey'));
...
$listGridClass = manage_list_grid_class('couponreg-list');
...
<?php require_once '../_layout_body_open.php'; ?>
                    ...
                    <div class="notes notes--lg">
                        ...
                        <ul class="notes__list">
                            <li>排序：建檔日期（由新至舊）。</li>
                            <li>「清單」可檢視該活動已發送的 coupon_d 明細。</li>
                        </ul>
                    </div>
