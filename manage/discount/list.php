...
$listCsrfKey = (string)($detailConfig['list_csrf'] ?? 'discount_list');
$table_name  = (string)($detailConfig['master'] ?? 'discount_p');
$PKName      = 'PKey';
$FKName      = (string)($detailConfig['fk'] ?? 'Discount_PKey');
...
$listGridClass = manage_list_grid_class('discount-list');
...
<?php require_once '../_layout_body_open.php'; ?>
                    ...
                    <div class="notes notes--lg">
                        ...
                        <ul class="notes__list">
                            <li>排序：開始日期（由新至舊）。</li>
                            <li>折抵方式分為「滿件折抵」「滿額折抵」，同模組活動期間不可重疊。</li>
                            <li>折抵金額預設為運費折抵金額（元）。</li>
                        </ul>
                    </div>
