...
$listCsrfKey = (string)($detailConfig['list_csrf'] ?? 'module_class_list');
...
$breadcrumbs = [
    ['label' => '單元管理'],
    ['label' => (string)($Module_Name ?? '模組類別管理')],
];
...
<?php require_once '../_layout_body_open.php'; ?>
                    ...
                    <section class="notes notes--lg">
                        ...
                        <ul class="notes__list">
                            <li>模組類別供後台單元分類使用；順序由小至大排列。</li>
                            <li>修改順序後請執行「儲存順序」；下架後該類別仍可保留於資料庫。</li>
                        </ul>
                    </section>
