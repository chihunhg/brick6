...
$listCsrfKey = 'class1_list';
$table_name  = (string)($detailConfig['master'] ?? 'dbclass1');
$PKName      = 'PKey';
$FKName      = (string)($detailConfig['fk'] ?? 'Class1_PKey');
...
$listGridClass = manage_list_grid_class('class1');
$detailConfig = require __DIR__ . '/_config.php';
