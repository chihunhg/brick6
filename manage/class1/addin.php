 ...
 * 複製到其他模組時：
 * 1. 複製本檔與 _config.php
 * 2. 調整 _config.php 的 master / lang / msg / img / fk / csrf
 * 3. 修改下方「主檔欄位」區塊以符合該表結構
 * 4. add.php、update.php 開頭使用 manage_detail_set_config()
 */
...
$csrfKey = (string)($detailConfig['csrf'] ?? 'class1_addin');
...
/** 表單主鍵（編輯）；優先 POST PKey，其次 Update_PKey */
