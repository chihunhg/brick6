                        ...
                        <article class="editView__tabs tabsGp">
                            ...
                            <div class="tabsGp__body">
                                ...
                                <div id="tabCon_<?php echo $i; ?>" class="tabContent --color<?php echo $i; ?>">
                                    ...
                                    <div class="formGrid">
                                        <label class="col--2 inputLabel editView__formLabel" for="strNote<?php echo $i; ?>">
                                            備註
                                        </label>
                                        <div class="col--10">
                                            <input name="strNote<?php echo $i; ?>" type="text"
                                                id="strNote<?php echo $i; ?>" class="formInput"
                                                maxlength="255"
                                                value="<?php echo e((string)($strNote[$i] ?? '')); ?>">
                                            <p class="notes">選填；前台 FAQ 列表可顯示於答案區上方（Day 6 練習欄位）。</p>
                                        </div>
                                    </div>
