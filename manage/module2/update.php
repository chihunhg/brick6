...
$__csrf_key = (string)($detailConfig['csrf'] ?? 'module2_addin');
...
if ((int)($GLOBALS['intType'] ?? 0) !== (int)($detailConfig['list_int_type'] ?? 2)) {
    manage_alert_script('此單元非美工頁面類型!', 'list.php');
    exit;
}

$breadcrumbs = [
    ['label' => '單元管理'],
    ['label' => '美工頁面', 'href' => 'list.php'],
