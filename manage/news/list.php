...
$listCsrfKey = 'news_list';
$table_name  = (string)($detailConfig['master'] ?? 'news');
$PKName      = 'PKey';
$FKName      = (string)($detailConfig['fk'] ?? 'News_PKey');
...
$sql = "SELECT * FROM {$table_name} {$PDO_Cond} ORDER BY OpenDate DESC, {$PKName} DESC LIMIT "
...
<?php require_once '../_layout_body_open.php'; ?>
                        ...
                        <div class="card filterWrap">
                            <div class="filterWrap__content">
                                <div class="filterWrap__grid">
                                    ...
                                    <div class="inputGroup">
                                        <label class="inputLabel" for="EndDate">刊登日期（迄）</label>
                                        <div class="inputWrapper">
                    ...
                    <div class="notes notes--lg">
                        ...
                        <ul class="notes__list">
                            <li>列表「順序」為目前頁次流水號；資料排序依「刊登日期」由新至舊，相同則依編號由大至小。</li>
                            <li>下架日期為「永不下架」時顯示「無」。</li>
