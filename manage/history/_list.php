...
$gridClass = 'tableGrid--history-list';
if ($showHomeColumn) {
...
foreach ($listRows as $row) {
    ...
    $rowYear = (int)($row['intYear'] ?? $row['Sort'] ?? 0);
        ...
        <div class="tableRow__data <?php echo e($gridClass); ?>">
            ...
            <div class="flex flex--jtCenter">
                <input type="text" name="Sort<?php echo $i; ?>" id="Sort<?php echo $i; ?>"
                    value="<?php echo $rowYear; ?>" maxlength="4"
                    class="tableRow__sortInput tableRow__sortInput--year" size="4" inputmode="numeric">
