...
$subPageName = "p2_1";
require("_inc.php");
$Module_PKey = frontend_module_pkey('knowledge');
...
<main class="pgContent">
    <section class="blockHeight blockHeight--migration">
        <div class="container">
            <h2 class="mainTitle">
            ...
            <div class="imgCardList imgCardList--pg --migration">
                <?php
				// 文章清單（參數化 + LIMIT 整數）
				...
				while (!$rs->eof) {
					...
					// 詳細頁連結（站內相對）
					$link_href = 'migration-services-detail' . (int)$rs->field('PKey') . '.htm';
				?>
