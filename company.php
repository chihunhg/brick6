...
/**
 * 前台公司簡介內頁（about.htm / company{N}.htm）
 *
 * 資料流程：註冊模組設定 → frontend_fetch_detail → 內文／圖片子表輸出。
 * 後台：manage/company/_config.php。
 */
 ...
 *
 * 使用方式：
 *   1. frontend_module_pkey_for_page('about.htm') — 依 PageLink 從後台選單反查 Module_PKey
 ...
 */
$Module_PKey = frontend_module_pkey_for_page('company.htm');
