...
/**
 * 前台產品列表（product.htm / product{N}.htm）
 *
 * 資料流程：註冊模組設定 → frontend_list_where → 分頁列表。
 * 內頁：product-detail.php；後台：manage/product/_config.php。
 */
 ...
 *
 * 使用方式：
 *   1. frontend_module_pkey_for_page('product.htm') — 依 PageLink 從後台選單反查 Module_PKey
 ...
 */
$Module_PKey = frontend_module_pkey_for_page('product.htm');
