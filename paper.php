...
/**
 * 前台技術文件列表（paper.htm / paper{N}.htm）
 *
 * 資料流程：註冊模組設定 → frontend_list_where → 分頁列表。
 * 內頁：paper-detail.php；後台：manage/paper/_config.php。
 */
...
if ($Module_PKey <= 0) {
    throw new RuntimeException('paper.php: 無法從選單設定取得 paper 單元的 Module_PKey（請確認後台 PageLink 為 paper.htm）');
}
